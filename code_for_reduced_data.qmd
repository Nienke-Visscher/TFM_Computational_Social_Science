...
#Load the data
data_panel <- read.csv("C:/Users/rnvis/Documents/Thesis_Forecasting_consumption_foodstuffs/Data/reduced_dataset.csv")
...
data_cat <- read.csv("C:/Users/rnvis/Documents/Thesis_Forecasting_consumption_foodstuffs/data_cat.csv")
...
p1 <- forecast_plot[[1]]
# Add labels to p1
p1 <- p1 + labs(subtitle = "", title = NULL, x = "Date", y = "Equivalent Units Sold")

#CANNOT BE USED WITH REDUCED DATA

#p2 <- forecast_plot[[2]]
## Add labels to p2
#p2 <- p2 + labs(subtitle = "", title = NULL, x = "Date", y = "Equivalent Units Sold")
#
#p3 <- forecast_plot[[3]]
## Add labels to p3
#p3 <- p3 + labs(subtitle = "", title = NULL, x = "Date", y = "Equivalent Units Sold")
#
#p4 <- forecast_plot[[4]]
## Add labels to p4
#p4 <- p4 + labs(subtitle = " ", title = NULL, x = "Date", y = "Equivalent Units Sold")
#
